...
fn test_all() {
    ...
    // SLLI x5, x1, 1
    read_ins(
        0x0 << 25 | 1 << 20 | 1 << 15 | 0x1 << 12 | 5 << 7 | 0b0010011,
        &mut cpu,
    );
    ...
    // SRLI x6, x1, 1
    read_ins(
        0x0 << 25 | 1 << 20 | 1 << 15 | 0x5 << 12 | 6 << 7 | 0b0010011,
        &mut cpu,
    );
    ...
    // SRAI x7, x1, 1
    read_ins(
        0x20 << 25 | 1 << 20 | 1 << 15 | 0x5 << 12 | 7 << 7 | 0b0010011,
        &mut cpu,
    );
    ...
    // SLTI x8, x1, 10
    read_ins(
        10 << 20 | 1 << 15 | 0x2 << 12 | 8 << 7 | 0b0010011,
        &mut cpu,
    );
    ...
    // SLTIU x9, x1, 10
    read_ins(
        10 << 20 | 1 << 15 | 0x3 << 12 | 9 << 7 | 0b0010011,
        &mut cpu,
    );
    ...
    // ADD x10, x1, x2
    read_ins(
        0x0 << 25 | 2 << 20 | 1 << 15 | 0x0 << 12 | 10 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // SUB x11, x2, x1
    read_ins(
        0x20 << 25 | 1 << 20 | 2 << 15 | 0x0 << 12 | 11 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // XOR x12, x1, x2
    read_ins(
        0x0 << 25 | 2 << 20 | 1 << 15 | 0x4 << 12 | 12 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // OR x13, x1, x2
    read_ins(
        0x0 << 25 | 2 << 20 | 1 << 15 | 0x6 << 12 | 13 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // AND x14, x1, x2
    read_ins(
        0x0 << 25 | 2 << 20 | 1 << 15 | 0x7 << 12 | 14 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // SLL x15, x1, x2
    read_ins(
        0x0 << 25 | 2 << 20 | 1 << 15 | 0x1 << 12 | 15 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // SLT x16, x1, x2
    read_ins(
        0x0 << 25 | 2 << 20 | 1 << 15 | 0x2 << 12 | 16 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // SLTU x17, x1, x2
    read_ins(
        0x0 << 25 | 2 << 20 | 1 << 15 | 0x3 << 12 | 17 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // SRL x18, x1, x2
    read_ins(
        0x0 << 25 | 2 << 20 | 1 << 15 | 0x5 << 12 | 18 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // SRA x19, x1, x2
    read_ins(
        0x20 << 25 | 2 << 20 | 1 << 15 | 0x5 << 12 | 19 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // MUL x20, x1, x2
    read_ins(
        0x01 << 25 | 2 << 20 | 1 << 15 | 0x0 << 12 | 20 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // MULH x21, x1, x2
    read_ins(
        0x01 << 25 | 2 << 20 | 1 << 15 | 0x1 << 12 | 21 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // MULHSU x22, x1, x2
    read_ins(
        0x01 << 25 | 2 << 20 | 1 << 15 | 0x2 << 12 | 22 << 7 | 0b0110011,
        &mut cpu,
    );
    ...
    // MULHU x23, x1, x2
    read_ins(
        0x01 << 25 | 2 << 20 | 1 << 15 | 0x3 << 12 | 23 << 7 | 0b0110011,
        &mut cpu,
    );
